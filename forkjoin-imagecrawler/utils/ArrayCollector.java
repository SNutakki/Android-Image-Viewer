...
public class ArrayCollector<T>
    ...
    public BiConsumer<Array<T>, T> accumulator() {
        // TODO - you fill in here
        return Array::add; // single value pushed to array
    }
    ...
    public BinaryOperator<Array<T>> combiner() {
        ...
        return (arrA, arrB) ->
        {
            arrA.addAll(arrB); // all values of B added to A
            return arrA;
        };
    }
    ...
    public Function<Array<T>, Array<T>> finisher() {
        // TODO - you fill in here
        return Function.identity(); // no extra transformations, so param is returned
    }
    ...
    public Set characteristics() {
        // TODO - you fill in here
        return Collections.singleton(Characteristics.IDENTITY_FINISH); // no extra ops in finisher
    }
