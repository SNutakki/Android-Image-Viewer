...
public class ParallelStreamsCrawler
    ...
    protected int performCrawl(String pageUri, int depth) {
        ...
        // this page.
            ...
            try {
                ...
                return imagesOnPage + // # of images on current page
                        imagesOnPageLinks.parallelStream() // # of images on pages recursed through
    ...
    private Array<Integer> crawlHyperLinksOnPage(Crawler.Page page,
        ...
        return page.getObjectsAsStrings(PAGE) // get urls on page
                .parallelStream()
                .map(uri->performCrawl(uri,depth)) // recursively go through linked pages and get
                                                    // # of images
                .collect(ArrayCollector.toArray()); // put # for each page in array
    ...
    private int processImages(Array<URL> urls) {
        ...
        return (int)urls.parallelStream()
                .map(this::getImage)
                .flatMap(this::transformImage) // for each image, get multiple transformed images
                                                // as a stream
    ...
    private Stream<Image> transformImage(Image image) {
        ...
        return mTransforms.parallelStream()
                // for each transformation, apply the tansformation to the given image
                // and return a stream of transformed images
